#!/bin/sh
# Entrypoint for plm-tcin-mapper FastAPI service.
#
...
echo "Starting plm-tcin-mapper — workers=${GUNICORN_WORKERS}, port=${APP_PORT}, config_dir=${APP_CONFIG_DIR}"

exec .venv/bin/gunicorn plm_tcin_mapper.main:app \
