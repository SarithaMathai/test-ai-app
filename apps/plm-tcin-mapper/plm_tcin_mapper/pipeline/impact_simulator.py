...
class ImpactSimulator:
    ...
    def estimate_impact(
        ...
        if parameter == "auto_confirm_threshold":
            return self._estimate_auto_confirm_impact(
                current_value, proposed_value, current_correction_rate
            )
        elif parameter == "llm_fallback_threshold":
            return self._estimate_llm_threshold_impact(
                current_value, proposed_value, current_correction_rate
            )
        elif parameter == "fuzzy_match_weight":
            return self._estimate_fuzzy_weight_impact(
                current_value, proposed_value, current_correction_rate
            )
        else:
            return {}
