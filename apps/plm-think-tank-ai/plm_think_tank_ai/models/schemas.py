"""Pydantic request/response schemas for the PLM Think Tank AI API."""
...
class PromptRequest(BaseModel):
    ...
    operation: str = Field(
        ...,
        description="Operation name that maps to a PLM prompt template (e.g. 'spell-checker').",
...
class PromptResponse(BaseModel):
    """Response envelope for POST /api/v1/prompt."""
