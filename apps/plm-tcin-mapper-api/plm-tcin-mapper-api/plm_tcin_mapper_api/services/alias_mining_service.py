...
from plm_tcin_mapper_api.database.models import AliasMiningProposal, FeedbackAction, ProposalStatus, ProposalType
from plm_tcin_mapper_api.matching.color_keywords import tokenize
...
class AliasMiningService:
    ...
    def _extract_keyword_patterns(self, feedback_records: list[Any]) -> dict[str, KeywordCorrection]:
        ...
        for feedback in feedback_records:
            ...
            original_colors = {self._keyword_map[t] for t in original_tokens if t in self._keyword_map}
            suggested_colors = {self._keyword_map[t] for t in suggested_tokens if t in self._keyword_map}
